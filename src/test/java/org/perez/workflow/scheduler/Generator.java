...
{
    public static Workflow randomWorkflow(long seed, int n_nodes, int n_edges, double min_cf, double max_cf, boolean connected) {
    ...
    public static Workflow connectedRandomWorkflow(long seed, int n_nodes, double min_cf, double max_cf)
    {
        Random rnd = new Random(seed);
        Task[] tasks = new Task[n_nodes];
        Workflow w = new Workflow();
